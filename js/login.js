async function submit() {
    ...
    const req = await fetch("http://sltcv.herokuapp.com/login", {body: JSON.stringify({email: eml, password: psd}), method:"POST", mode:"cors", headers: {"Content-Type": "application/json"}});

async function submit() {
    ...
    const req = await fetch("http://localhost:3000/login", {body: JSON.stringify({email: eml, password: psd}), method:"POST", mode:"cors", headers: {"Content-Type": "application/json"}});
